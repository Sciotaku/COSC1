...
left_up_paddle = False  # Check if the left paddle is moving up
left_down_paddle = False  # Check if the left paddle is moving down
right_up_paddle = False  # Check if the right paddle is moving up
right_down_paddle = False  # Check if the right paddle is moving down

# Check the status of the game
quit_game = False
restart_game = False
hit_left_wall = False  # Check if the ball hits the left wall
hit_right_wall = False  # Check if the ball hits the right wall
...
def release(key):
    global right_up_paddle, right_down_paddle, left_down_paddle, left_up_paddle, restart_game, c_y, c_x
    if key == "z":
...
def ball():
    global y_left_paddle, y_right_paddle, left_up_paddle, left_down_paddle, right_up_paddle, right_down_paddle
    global c_x, c_vx, c_y, c_vy, hit_left_wall, hit_right_wall, restart_game
