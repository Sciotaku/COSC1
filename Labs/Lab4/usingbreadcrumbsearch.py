# Author: Rahul Gupta
# Date: 03/08/2023
# Purpose: Lab 4 EC: map_plot function
# Use breadcrumb search and connect the start and goal vertex with a straight red line

from cs1lib import *
from load_graph import *
from breadcrumbsearch import breadcrumb_search
...
def draw_map():
    ...
    path = breadcrumb_search(start_vertex, goal_vertex)
    if path is not None:
